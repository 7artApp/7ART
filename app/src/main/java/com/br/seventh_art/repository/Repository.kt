...
class Repository{
    ...
    suspend fun getMovieRecommendationsService(movie_genre: MutableLiveData<Int>): MoviesRecommendationsResponse = serviceApp.getMoviesRecommendations(movie_genre, API_KEY)
